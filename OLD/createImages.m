...
%nNoise = [2]; % 1536x1536 affected up to level 10
nS1 = 3;
nS2 = 5;
...
% % B4 - old method, using this would (with old B5 block) cause B4 and B5 to use different
% fathers
% imageN2S1F1R1_Father = rectsurr2(imageOrig, nNoise, wv, cz, 19/20);
% imageN2S1F1R1_Father = uint8(imageN2S1F1R1_Father);
% imwrite(imageN2S1F1R1_Father,strcat('/data/projects/ImNatural/ImDegrade/B4/N2S1F1R1_',num2str(j),'_Father.tiff'))
% imageN2S1F1R1_FatherResize = imageN2S1F1R1_Father(111:1426,111:1426); %This will be region to crop to...
% imageN2S1F1R1_FatherResize = imresize(imageN2S1F1R1_FatherResize,0.5835);
% imwrite(imageN2S1F1R1_FatherResize,strcat('/data/projects/ImNatural/ImDegrade/B4/N2S1F1R1_',num2str(j),'_1.tiff'))
% 
% imageN2S1F1R1_Child = rectsurr2(imageN2S1F1R1_Father, nS1, wv, cz, 19/20);
% imageN2S1F1R1_Child = uint8(imageN2S1F1R1_Child);
% imageN2S1F1R1_ChildResize = imageN2S1F1R1_Child(111:1426,111:1426); %This will be region to crop to...
% imageN2S1F1R1_ChildResize = imresize(imageN2S1F1R1_ChildResize,0.5835);
% imwrite(imageN2S1F1R1_ChildResize,strcat('/data/projects/ImNatural/ImDegrade/B4/N2S1F1R1_',num2str(j),'_2.tiff'))

% B4 and B5 - this makes B4 and B5 use the same father
imageN2S1F2R1_Father = rectsurr2(imageOrig, nNoise, wv, cz, 19/20);
imageN2S1F2R1_Father = uint8(imageN2S1F2R1_Father);
imwrite(imageN2S1F2R1_Father,strcat('/data/projects/ImNatural/ImDegrade/B4/N2S1F1R1_',num2str(j),'._Father.tiff'))
imwrite(imageN2S1F2R1_Father,strcat('/data/projects/ImNatural/ImDegrade/B5/N2S1F2R1_',num2str(j),'._Father.tiff'))
for k = 1:16
    imageN2S1F2R1_Child = rectsurr2(imageN2S1F2R1_Father, nS1, wv, cz, 19/20);
...
% B6 
imageN3S1F1R1_Father = rectsurr2(imageOrig, nAllButS1, wv, cz, 19/20);
...
% OLD B9 and B10 - used different fathers
% % B9
% imageN2S2F1R1_Father = rectsurr2(imageOrig, nNoise, wv, cz, 19/20);
% imageN2S2F1R1_Father = uint8(imageN2S2F1R1_Father);
% imwrite(imageN2S2F1R1_Father,strcat('/data/projects/ImNatural/ImDegrade/B9/N2S2F1R1_',num2str(j),'_Father.tiff'))
% imageN2S2F1R1_FatherResize = imageN2S2F1R1_Father(111:1426,111:1426); %This will be region to crop to...
% imageN2S2F1R1_FatherResize = imresize(imageN2S2F1R1_FatherResize,0.5835);
% imwrite(imageN2S2F1R1_FatherResize,strcat('/data/projects/ImNatural/ImDegrade/B9/N2S2F1R1_',num2str(j),'_1.tiff'))
% 
% imageN2S2F1R1_Child = rectsurr2(imageN2S2F1R1_Father, nS2, wv, cz, 19/20);
% imageN2S2F1R1_Child = uint8(imageN2S2F1R1_Child);
% imageN2S2F1R1_ChildResize = imageN2S2F1R1_Child(111:1426,111:1426); %This will be region to crop to...
% imageN2S2F1R1_ChildResize = imresize(imageN2S2F1R1_ChildResize,0.5835);
% imwrite(imageN2S2F1R1_ChildResize,strcat('/data/projects/ImNatural/ImDegrade/B9/N2S2F1R1_',num2str(j),'_2.tiff'))

% % B10
% imageN2S2F2R1_Father = rectsurr2(imageOrig, nNoise, wv, cz, 19/20);
% imageN2S2F2R1_Father = uint8(imageN2S2F2R1_Father);
% imwrite(imageN2S2F2R1_Father,strcat('/data/projects/ImNatural/ImDegrade/B10/N2S2F2R1_',num2str(j),'_Father.tiff'))
% for k = 1:16
%     imageN2S2F2R1_Child = rectsurr2(imageN2S2F2R1_Father, nS2, wv, cz, 19/20);
...
% B9 and B10 - uses same father
imageN2S2F2R1_Father = rectsurr2(imageOrig, nNoise, wv, cz, 19/20);
imageN2S2F2R1_Father = uint8(imageN2S2F2R1_Father);
imwrite(imageN2S2F2R1_Father,strcat('/data/projects/ImNatural/ImDegrade/B9/N2S2F1R1_',num2str(j),'_Father.tiff'))
imwrite(imageN2S2F2R1_Father,strcat('/data/projects/ImNatural/ImDegrade/B10/N2S2F2R1_',num2str(j),'_Father.tiff'))
for k = 1:16
    imageN2S2F2R1_Child = rectsurr2(imageN2S2F2R1_Father, nS2, wv, cz, 19/20);
    imageN2S2F2R1_Child = uint8(imageN2S2F2R1_Child);
...
% B11 
imageN3S2F1R1_Father = rectsurr2(imageOrig, nAllButS2, wv, cz, 19/20);
...
% B12
imageNoise = rectsurr2(imageOrig, nNoise, wv, cz, 19/20);
...
%figure; imagesc(imageNoise); colormap gray; axis square
%figure; imagesc(imageNoiseResize); colormap gray; axis square
